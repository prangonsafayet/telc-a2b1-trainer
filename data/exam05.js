...
window.TELC_EXAMS.push({
  ...
  lesen: {
    ...
    teil2: {
      ...
      questions: [
        { textIndex: 0, frage: "Was kostet der Gesundheitstag für Erwachsene?", options: ["Nichts.", "3 Euro.", "14 Euro."], answer: 1 },
        { textIndex: 0, frage: "Was können die Besucher kostenlos machen?", options: ["Den Blutdruck messen lassen.", "Snacks und Säfte bekommen.", "Einen Kochkurs besuchen."], answer: 0 },
        { textIndex: 0, frage: "Wann beginnt der Vortrag über Ernährung?", options: ["Um 10 Uhr.", "Um 17 Uhr.", "Um 11 Uhr."], answer: 2 },
        { textIndex: 1, frage: "Wann öffnet das Schwimmbad ab Oktober am Montag?", options: ["Um 6:30 Uhr.", "Um 9 Uhr.", "Um 19 Uhr."], answer: 0 },
        { textIndex: 1, frage: "Warum ist die Sauna im Oktober geschlossen?", options: ["Sie ist zu klein.", "Sie wird renoviert.", "Es kommen zu wenige Gäste."], answer: 1 }
      ]
    },
    teil3: {
  ...
  sprachbausteine: {
    ...
    teil2: {
      ...
      wordBank: ["Abend", "kostet", "werden", "Morgen", "Informationen", "gelesen", "Hilfe", "kauft", "Fragen", "gegangen", "machen", "teuer"],
      answers: [2, 1, 5, 0, 4, 6]
    },
    teil3: {
      anweisung: "Was antworten Sie? Kreuzen Sie die passende Antwort an: a, b oder c.",
      items: [
        { prompt: "\"Was fehlt Ihnen denn?\"", options: ["Ich habe seit gestern starke Halsschmerzen.", "Mir fehlt ein Rezept.", "Ich fühle mich sehr gut, danke."], answer: 0 },
        { prompt: "\"Treibst du regelmäßig Sport?\"", options: ["Nein, Sport ist gesund.", "Ja, ich schwimme zweimal pro Woche.", "Ja, ich habe keinen Sport."], answer: 1 },
        { prompt: "\"Gute Besserung!\"", options: ["Ja, sehr gern.", "Bitte schön.", "Danke schön!"], answer: 2 },
        { prompt: "\"Soll ich dir eine Schmerztablette holen?\"", options: ["Ja, bitte. Mein Kopf tut sehr weh.", "Nein, ich habe keine Tabletten.", "Die Apotheke ist heute geschlossen."], answer: 0 },
        { prompt: "\"Wollen wir morgen zusammen schwimmen gehen?\"", options: ["Nein, ich kann sehr gut schwimmen.", "Gern, aber erst am Nachmittag.", "Das Wasser war gestern kalt."], answer: 1 }
      ]
    }
  },
  ...
  hoeren: {
    teil1: {
      ...
      items: [
        {
          audio: "Guten Tag, hier ist die Praxis Doktor Hoffmann. Unsere Sprechstunde ist heute nur bis zwölf Uhr. In dringenden Fällen rufen Sie bitte den ärztlichen Notdienst an. Ab morgen sind wir wieder wie gewohnt für Sie da.",
          statement: "Die Praxis ist heute nur bis zwölf Uhr geöffnet.",
          answer: true
        },
        {
          audio: "Liebe Sportfreunde, herzlich willkommen im Stadion! Das Spiel beginnt heute fünfzehn Minuten später, also um fünfzehn Uhr fünfzehn. Bitte haben Sie noch etwas Geduld. Vielen Dank!",
          statement: "Das Spiel beginnt pünktlich um fünfzehn Uhr.",
          answer: false
        },
        {
          audio: "Liebe Mitglieder, ein wichtiger Hinweis: Der Zumba-Kurs fällt heute leider aus, weil die Trainerin krank ist. Ab nächster Woche findet der Kurs wieder wie immer donnerstags statt.",
          statement: "Der Zumba-Kurs fällt heute aus.",
          answer: true
        },
        {
          audio: "Liebe Kundinnen und Kunden, unsere Apotheke schließt in fünfzehn Minuten. Und denken Sie daran: Ab Montag finden Sie uns in der Gartenstraße acht, direkt neben der Bäckerei.",
    ...
    teil2: {
      ...
      items: [
        {
          audio: "Und hier unser Gesundheitstipp: Trinken Sie am Tag ungefähr zwei Liter Wasser, besonders wenn Sie Sport machen. Kaffee und Cola sind übrigens kein Ersatz für Wasser.",
          frage: "Wie viel Wasser soll man am Tag trinken?",
          options: ["Einen Liter.", "Zwei Liter.", "Drei Liter."],
          answer: 1
        },
        {
          audio: "Radio Neustadt informiert: Am Sonntag findet der große Stadtlauf statt. Der Start ist um zehn Uhr am Rathaus. Wegen des Laufs sind viele Straßen im Zentrum bis vierzehn Uhr gesperrt.",
          frage: "Wo startet der Stadtlauf?",
          options: ["Am Stadion.", "Am Stadtpark.", "Am Rathaus."],
          answer: 2
        },
        {
          audio: "Das Wetter für das Wochenende: Am Samstag bleibt es trocken und warm, perfekt für Sport im Freien. Am Sonntag müssen Sie mit Gewittern rechnen, bleiben Sie am Nachmittag besser drinnen.",
          frage: "Wie wird das Wetter am Samstag?",
          options: ["Trocken und warm.", "Es gibt Gewitter.", "Es wird kalt."],
          answer: 0
        },
        {
          audio: "Eine Information für alle Badegäste: Das Hallenbad ist nächste Woche wegen der jährlichen Reinigung geschlossen. Das Freibad im Süden der Stadt ist aber täglich von neun bis zwanzig Uhr geöffnet.",
      ...
      items: [
        {
          audio: [
            ...
            { speaker: "Apothekerin", text: "Gern. Dieser Saft hilft sehr gut. Nehmen Sie ihn dreimal am Tag nach dem Essen." },
        ...
        },
        {
          audio: [
            ...
            { speaker: "Ben", text: "Heute nicht, mein Knie tut weh. Der Arzt hat gesagt, ich soll eine Woche Pause machen." },
        ...
        },
        {
          audio: [
            ...
            { speaker: "Sprechstundenhilfe", text: "Nächste Woche Dienstag um neun Uhr ist etwas frei. Passt das?" },
        ...
        },
        {
          audio: [
            ...
            { speaker: "Vater", text: "Die liegt noch im Auto. Komm, wir müssen los, dein Kurs beginnt um vier Uhr." }
          ],
    ...
    teil4: {
      ...
      audio: [
        { speaker: "Moderator", text: "Herzlich willkommen bei Radio Fit! Heute ist Katja Brandt bei uns. Katja, du bist Schwimmtrainerin. Wie lange machst du diesen Beruf schon?" },
        { speaker: "Katja", text: "Seit acht Jahren. Zuerst habe ich Kinder trainiert, jetzt arbeite ich vor allem mit Erwachsenen, die schwimmen lernen wollen." },
        { speaker: "Moderator", text: "Erwachsene, die nicht schwimmen können – gibt es davon viele?" },
        { speaker: "Katja", text: "Ja, mehr als man denkt. Viele hatten als Kind keine Möglichkeit, oder sie hatten Angst vor dem Wasser." },
        { speaker: "Moderator", text: "Und wie lange dauert es, bis ein Erwachsener schwimmen kann?" },
        { speaker: "Katja", text: "Das ist verschieden. Die meisten brauchen ungefähr zehn Stunden, dann können sie sicher schwimmen." },
        { speaker: "Moderator", text: "Was ist dein Tipp für unsere Hörerinnen und Hörer?" },
        { speaker: "Katja", text: "Gehen Sie regelmäßig schwimmen, am besten einmal pro Woche. Schwimmen ist gesund für den Rücken, und man kann es bis ins hohe Alter machen." }
      ],
      questions: [
        { frage: "Wie lange arbeitet Katja schon als Trainerin?", options: ["Seit acht Jahren.", "Seit zehn Jahren.", "Seit einem Jahr."], answer: 0 },
        { frage: "Mit wem arbeitet Katja heute vor allem?", options: ["Mit Kindern.", "Mit Erwachsenen.", "Mit alten Menschen."], answer: 1 },
        { frage: "Wie viele Stunden brauchen die meisten Erwachsenen?", options: ["Ungefähr fünf Stunden.", "Ungefähr acht Stunden.", "Ungefähr zehn Stunden."], answer: 2 },
        { frage: "Wie oft soll man laut Katja schwimmen gehen?", options: ["Jeden Tag.", "Einmal pro Woche.", "Einmal pro Monat."], answer: 1 }
      ]
    },
    teil5: {
      anweisung: "Sie hören eine Nachricht auf dem Anrufbeantworter. Ergänzen Sie die Notiz.",
      audio: "Guten Tag, hier spricht Herr Lindner von der Praxis Physio Aktiv. Ihre Behandlung am Montag müssen wir leider verschieben. Der neue Termin ist am Donnerstag um Viertel nach acht. Bitte bringen Sie bequeme Sportkleidung und ein Handtuch mit. Wenn Sie Fragen haben, erreichen Sie uns unter null vier null, sieben sieben zwei drei. Vielen Dank und auf Wiederhören!",
      ...
      gaps: [
        ...
        { label: "Uhrzeit: ____ Uhr", answer: "8:15", alt: ["8.15", "Viertel nach acht", "viertel nach acht", "08:15", "815"] },
  ...
  schreiben: {
    ...
    tipps: "Answer all three points and connect your ideas with 'und', 'aber' or 'weil'. A concrete suggestion (sport + day + time) makes point two easy to fulfil."
  },
  ...
  sprechen: {
    ...
    teil3: {
      ...
      punkte: ["Wann? (Tag und Uhrzeit)", "Welcher Sport?", "Wo? (Park, Sporthalle, Schwimmbad?)", "Was brauchen wir? (Essen, Getränke, Bälle?)"],
      redemittel: [
