...
export function slotHeading(slot: ScheduleSlot): string {
...
export function describePlanShape(days: number): string {
...
export function describeClamp(schedule: Schedule): string | null {
...
export function describeLearnLead(schedule: Schedule): string {
  if (schedule.phase === 'past-due') {
...
/** The Dashboard lead. */
export function describeMockLead(schedule: Schedule, examCount: number): string {
...
export function examSlotLabel(schedule: Schedule | null, examId: number): string | null {
