...
/**
 * Brand marks for the OAuth buttons, inlined as SVG. A sign-in button is one of the few
 * places a provider's own mark is the clearest possible label, and lucide ships only
 * generic icons.
 */
export const GoogleIcon = ({ className }: ProviderIconProps) => (
...
export const GitHubIcon = ({ className }: ProviderIconProps) => (
