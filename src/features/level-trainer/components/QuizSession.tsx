...
import { type QuizSession as QuizSessionState } from '../lib/practiceStore.ts';
...
export const QuizSession = ({ session, done, onChoose, onNext, onRestart, onClose }: QuizSessionProps) => {
  if (done) {
    return (
      <SessionSummary
        kind="quiz"
