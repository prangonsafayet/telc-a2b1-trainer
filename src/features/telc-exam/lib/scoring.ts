...
export interface TelcModuleScore {
...
export const scoreTelcLesen = (exam: TelcExam, answers: AnswerMap): TelcModuleScore => {
...
export const scoreTelcSprachbausteine = (exam: TelcExam, answers: AnswerMap): TelcModuleScore => {
...
export const scoreTelcHoeren = (exam: TelcExam, answers: AnswerMap): TelcModuleScore => {
...
export const gradeTelcExam = (scores: TelcSectionScores): TelcGrade => {
  const written =
...
export const countTelcUnanswered = (exam: TelcExam, module: ExamModule, answers: AnswerMap): number => {
