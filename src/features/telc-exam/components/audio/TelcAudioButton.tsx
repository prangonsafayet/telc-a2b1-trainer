...
import { useTelcAudioPlayback } from '@features/telc-exam/hooks/useTelcAudioPlayback.ts';
...
const TelcAudioButton = ({ exam, itemKey, playsLeft, onConsumePlay }: TelcAudioButtonProps) => {
...
export default TelcAudioButton;
