...
const SprechenModule = ({ exam, paper, recordings, onRecorded }: A2b1ModuleProps) => {
  const { sprechen } = exam;
  ...
  return (
    <>
      ...
      <Teil
        ...
        chip={paper.sprechenChips[0] ?? ''}
        anweisung={sprechen.teil1.anweisung}
      >
      ...
      <Teil title="Teil 2 — Über ein Thema sprechen" chip={paper.sprechenChips[1] ?? ''}>
      ...
      <Teil title="Teil 3 — Gemeinsam planen" chip={paper.sprechenChips[2] ?? ''}>
