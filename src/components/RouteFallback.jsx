...
/* Shown while a lazily-loaded route chunk is in flight. It mirrors the rough shape of
   a content page so the layout does not jump when the real screen arrives. */
