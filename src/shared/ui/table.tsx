...
export const TableRow = forwardRef<HTMLTableRowElement, ComponentPropsWithoutRef<'tr'>>(function TableRow(
  { className, ...props },
  ref
) {
  return (
...
export const TableHead = forwardRef<HTMLTableCellElement, ComponentPropsWithoutRef<'th'>>(function TableHead(
  { className, ...props },
  ref
) {
  return (
...
export const TableCell = forwardRef<HTMLTableCellElement, ComponentPropsWithoutRef<'td'>>(function TableCell(
  { className, ...props },
  ref
) {
