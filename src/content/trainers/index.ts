import { type LevelContent, type TelcExam, type TelcLevel, type VocabBank } from '@shared/types';
...
export const LEVEL_CONTENT: Readonly<Record<TelcLevel, LevelContent>> = {
  b1: B1_CONTENT,
  b2: B2_CONTENT
};

/** Looks up an exam by id; accepts the string form that arrives from route params. */
export const findTelcExam = (level: TelcLevel, id: string | number | undefined): TelcExam | undefined => {
