...
/* The B2 28-day curriculum. Days 1–14 are the core tier and are always scheduled;
  ...
  days: [
    {
      ...
      focus: 'Akkusativ vs. Dativ — the backbone of every B2 sentence',
      tasks: [
        ...
        'Read the B2 exam guide: format, points and pass rules'
      ],
      cheats: [],
      ai: [
        {
          t: 'Case drill',
          p: 'Du bist mein Deutschtrainer (Niveau B2). Stelle mir 15 Lückensätze, in denen ich zwischen Akkusativ und Dativ entscheiden muss. Korrigiere jede Antwort sofort und erkläre kurz auf Englisch, warum der Kasus richtig ist.'
        }
      ]
    },
    {
      ...
      ai: [
        {
          t: 'Tense debrief',
          p: 'Du bist mein Deutschtrainer (Niveau B2). Ich schreibe dir 8 Sätze über gestern im Perfekt. Korrigiere Fehler, erkläre die Korrekturen kurz auf Englisch und frage danach mündlich weiter.'
        }
      ]
    }
  ]
